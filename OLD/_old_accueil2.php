	...
	<body>
		...
		if((isset($result)) OR ($donnees == TRUE)){
			...
			catch(Exception $f)
			{
				...
				<div class="span2">
					<i class="icon-search"></i><button id="cible" class="btn btn-link" style="oui">Filtrer</button>
				</div>
				<div class="span2">
					<i class="icon-search"></i><button id="tout" class="btn btn-link">Tout afficher</button>	
				</div>
